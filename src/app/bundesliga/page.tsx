/*This page.tsx is for the Bundesliga standings section*/ 
...
async function getBundesligaStandings(){
...
export default async function bundesliga() {

    const bundesligaStandings = await getBundesligaStandings();

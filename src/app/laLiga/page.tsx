/*This page.tsx is for the LaLiga standings section*/ 
...
async function getLaLigaStandings(){
...
export default async function laLiga() {

    const laLigaStandings = await getLaLigaStandings();
